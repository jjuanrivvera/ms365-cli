# Makefile — ms365 (Microsoft 365 CLI), built to the cliwright standard.
...
COVERAGE_MIN ?= 80
# spec-completeness: min % of the enumerated Microsoft Graph v1.0 API the manifest must wrap
API_COVERAGE_MIN ?= 90
