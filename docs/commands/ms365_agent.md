...
Generate safety configuration for AI agents that drive ms365.
...
* [ms365 agent guard](ms365_agent_guard.md)	 - Generate agent-safety config that blocks destructive ms365 operations
